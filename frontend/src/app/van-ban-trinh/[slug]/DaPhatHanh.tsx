...
export default function DaPhatHanh() {
    ...
    <div className="w-full min-h-full bg-white shadow-sm border border-gray-200">
      <div className="p-4 border-b border-gray-200">
        <div className="flex justify-between items-start mb-4">
          <h1 className="text-[22px] font-normal text-gray-800">Danh sách Văn bản trình đã phát hành</h1>
              ...
              paginatedData.map((row, index) => (
                <tr key={index} className="border-b border-gray-200 hover:bg-gray-50 transition-colors text-gray-800">
                  ...
                  <td className="p-3 text-center">
                    <span className="inline-block bg-[#198754] text-white px-2.5 py-1 rounded-[10px] text-[12px] font-medium whitespace-nowrap">
                      {row.trangThai}
                    </span>
                  </td>
                </tr>
      ...
      <DocumentDetailModal 
        ...
        title="Chi tiết văn bản trình đã phát hành"
      />
