...
export default function HoSoThamGia() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      setIsLoading(true);
      try {
        const res = await workRecordService.getParticipated(0, 1000);
    ...
    <div className="w-full min-h-full bg-white shadow-sm border border-gray-200">
      <div className="p-4 border-b border-gray-200">
        <div className="flex justify-between items-start mb-2">
          <h1 className="text-[22px] font-normal text-gray-800">Danh sách hồ sơ công việc tham gia</h1>
