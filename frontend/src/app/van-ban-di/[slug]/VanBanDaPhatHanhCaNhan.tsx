...
export default function VanBanDaPhatHanhCaNhan() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      setIsLoading(true);
      try {
        const res = await outgoingService.getMyPublished(0, 1000);
  ...
  return (
    <div className="w-full min-h-full bg-white shadow-sm border border-gray-200">
      <div className="p-4 border-b border-gray-200 flex justify-between items-center">
        <h1 className="text-[22px] font-normal text-gray-800">Danh sách Văn bản đã phát hành của cá nhân</h1>
