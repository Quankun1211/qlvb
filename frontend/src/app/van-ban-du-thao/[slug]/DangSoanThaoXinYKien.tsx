    ...
    <div className="w-full min-h-full bg-white shadow-sm border border-gray-200">
      <div className="p-4 border-b border-gray-200">
        <div className="flex justify-between items-start mb-4">
          <h1 className="text-[22px] font-normal text-gray-800">Danh sách dự thảo đang soạn thảo/Xin ý kiến</h1>
        ...
        <table className="w-full border-collapse text-[13px] mb-4">
          <thead>
            <tr>
              ...
              <th className="py-2.5 px-3 border border-gray-300 text-center font-bold text-gray-800 bg-white w-[15%]">Cán bộ cho ý kiến</th>
              <th className="py-2.5 px-3 border border-gray-300 text-center font-bold text-gray-800 bg-white w-[10%]">Trạng thái</th>
              <th className="py-2.5 px-3 border border-gray-300 text-center font-bold text-gray-800 bg-white w-[5%]">Sửa</th>
            </tr>
          </thead>
          <tbody>
            {paginatedData.length > 0 ? (
              paginatedData.map((row, index) => (
                <tr key={index} className="hover:bg-gray-50 transition-colors text-gray-900">
                  ...
                  <td className="py-2.5 px-3 border border-gray-300 text-center text-gray-700">{row.canBo}</td>
                  <td className="py-2.5 px-3 border border-gray-300 text-center">
                    <span className="text-[#005fb8]">{row.trangThai}</span>
                  </td>
                  <td className="py-2.5 px-3 border border-gray-300 text-center text-blue-600 hover:underline cursor-pointer">Sửa</td>
                </tr>
              ))
            ) : (
              <tr>
